				...
				<ul class="side-menu">
                    ...
                    @can('الفواتير')
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a class="slide-item" href="{{ url('/' . $page='Invoice_Paid') }}">فواتير مدفوعه </a></li>
                                @endcan
                                @can('الفواتير الغير مدفوعة')
                                <li><a class="slide-item" href="{{ url('/' . $page='Invoice_UnPaid') }}">فواتير غير مدفوعه</a></li>
                                @endcan
                                @can('الفواتير المدفوعة جزئيا')
                                <li><a class="slide-item" href="{{ url('/' . $page='Invoice_Partial') }}">فواتير المدفوعه جزئيا</a></li>
                                @endcan
                                @can('ارشيف الفواتير')
                                <li><a class="slide-item" href="{{ url('/' . $page='Achive') }}">ارشفه الفواتير</a></li>
                                @endcan
                            </ul>
                        </li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @endcan
                            @can('المنتجات')
							<li><a class="slide-item" href="{{ url('/' . $page='product') }}">اضافه منتج </a></li>
                            @endcan
                        </ul>
                    </li>
                    @endcan
                    ...
                    @can('المستخدمين')
                    <li class="side-item side-item-category">كل المستخدمين</li>
					<li class="slide">
