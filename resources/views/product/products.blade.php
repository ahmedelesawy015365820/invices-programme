                            ...
                            <div class="modal-content modal-content-demo">
                                ...
                                <form action="{{route('product.store')}}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label for="dscription">الوصف</label>
                                            <textarea class="form-control" id="dscription" name="dscription" rows="3"></textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-12">
                            ...
                            <div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<div class="col-sm-6 col-md-4 col-xl-3">
										<a class="modal-effect btn btn-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">اضافه منتج</a>
									</div>
                                </div>
							</div>
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="modal-effect btn btn-sm btn-outline-info" data-effect="effect-scale"
                                                            ...
                                                            data-description="{{ $Product->dscription }}" 
                       ...
                       <div class="modal-dialog" role="document">
                           <div class="modal-content">
                               ...
                               <div class="modal-body">
                               <form action="product/update" class="edit-form" method="Post" autocomplete="off">
                                    {{method_field('patch')}}
                                    @csrf
                                    <div>
                                       <div class="form-group">
                                       ...
                                       <div class="form-group">
                                           ...
                                           <textarea class="form-control" id="description" name="dscription"></textarea>
                                       </div>
                                    </div>
                                    <div class="modal-footer">
