                            ...
                            <form action="{{route('section.store')}}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="section" name="section_name" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">الوصف</label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" name="discrption" rows="3"></textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-12">
                            ...
                            <div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<div class="col-sm-6 col-md-4 col-xl-3">
										<a class="modal-effect btn btn-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">اضافه قسم</a>
									</div>
                                </div>
							</div>
                            <div class="card-body">
                                        ...
                                        <?php  $i=0 ?>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$section->discrption}}</td>
                                                    <td>
                                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                            data-id="{{ $section->id }}" data-section_name="{{ $section->section_name }}"
                                                            data-discrption="{{ $section->discrption }}" data-toggle="modal" href="#exampleModal2"
                       ...
                       <div class="modal-dialog" role="document">
                           <div class="modal-content">
                               ...
                               <div class="modal-body">
                                <form action="section/update" class="edit-form" method="post" autocomplete="off">
                                    {{method_field('patch')}}
                                    @csrf
                                       <div class="form-group">
                                       ...
                                       <div class="form-group">
                                           ...
                                           <textarea class="form-control" id="discrption" name="discrption"></textarea>
                                       </div>
                               </div>
                               <div class="modal-footer">
...
<script>
        $('#exampleModal2').on('show.bs.modal', function(event) {
            ...
            var discrption = button.data('discrption')
            var modal = $(this)
            modal.find('.modal-body #id').val(id);
            modal.find('.modal-body #section_name').val(section_name);
            modal.find('.modal-body #discrption').val(discrption);
        });
